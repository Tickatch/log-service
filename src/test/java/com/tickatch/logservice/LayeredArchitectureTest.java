package com.tickatch.logservice;
...
@AnalyzeClasses(
    packages = "com.tickatch.logservice",
    importOptions = ImportOption.DoNotIncludeTests.class)
class LayeredArchitectureTest {

  private static final String[] DOMAIN_PACKAGES = {
    "com.tickatch.logservice.example.domain..",
  };
  ...
  public void layeredArchitecture(JavaClasses classes) {
    Architectures.layeredArchitecture()
        ...
        .layer("Presentation")
        .definedBy("com.tickatch.logservice..presentation..")
        .layer("Application")
        .definedBy("com.tickatch.logservice..application..")
        .layer("Domain")
        .definedBy("com.tickatch.logservice..domain..")
        .layer("Infrastructure")
        .definedBy("com.tickatch.logservice..infrastructure..")
        ...
        .ignoreDependency(
            ...
            JavaClass.Predicates.resideInAPackage("com.tickatch.logservice.global.."))
        // 빈 레이어 허용
  ...
  public void globalShouldNotDependOnDomains(JavaClasses classes) {
    ...
    // global 패키지가 없으면 스킵
    if (!hasClassesInPackage(classes, "com.tickatch.logservice.global..")) {
      return;
    }

    noClasses()
        .that()
        .resideInAPackage("com.tickatch.logservice.global..")
        .should()
        .dependOnClassesThat()
